...
export default function FlashBanner() {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 border-y border-primary/20"
    >
      <div className="container py-3 flex items-center justify-center gap-3 text-sm">
        <Zap size={16} className="text-primary animate-pulse" />
        <span className="font-heading font-bold text-primary">FLASH SALE</span>
        <span className="text-muted-foreground">se termine dans</span>
