...
export default function OrderForm({ product, quantity, onClose }: OrderFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Insert without returning data (anon has no SELECT on orders)
      const { error: orderError } = await supabase.from("orders").insert({
        id: orderId,
        order_number: "TEMP", // overwritten by DB trigger
      ...
      // Order number generated by DB trigger - use orderId prefix for client reference
