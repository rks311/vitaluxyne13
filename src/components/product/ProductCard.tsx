    ...
    >
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          {product.is_top_sale && <span className="badge-top text-[9px] px-1.5">🔥 Top</span>}
      ...
      <div className="p-2.5 md:p-3 flex-1 flex flex-col">
        ...
        <div className="mt-auto">
          <div className="flex items-baseline gap-1.5 mb-2">
            ...
            {product.old_price && (
              <span className="text-[9px] text-muted-foreground line-through">{formatPrice(product.old_price)}</span>
            )}
          </div>
