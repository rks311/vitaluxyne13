    ...
    <footer className="bg-surface border-t border-border pb-20 md:pb-0">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-heading font-semibold mb-3 text-sm uppercase tracking-wider">{t("footer.navigation")}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/catalogue" className="hover:text-primary transition-colors">{t("nav.catalog")}</Link></li>
              <li><Link to="/catalogue?cat=packs" className="hover:text-primary transition-colors">{t("nav.packs")}</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-heading font-semibold mb-3 text-sm uppercase tracking-wider">{t("footer.info")}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>{t("footer.faq")}</li>
          ...
          <div>
            <h4 className="font-heading font-semibold mb-3 text-sm uppercase tracking-wider">{t("footer.contact")}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
