...
const ADMIN_EMAIL = "admin@ultranutrition.dz";
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="admin@ultranutrition.dz"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full h-12 rounded-md bg-card border border-border px-4 pr-10 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
                required
                maxLength={50}
              />
              <button
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-12 gradient-primary text-primary-foreground font-heading text-base"
          >
